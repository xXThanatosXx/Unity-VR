...
{
    internal class ParameterizedIgnoreCommand : TestCommand
    {
        ...
        public ParameterizedIgnoreCommand(TestCommand command, object[] arguments, string reason = "") : base(command.Test)
        {
            m_Command = command;
            Arguments = arguments;
            Reason = reason;
